 ...
 * @since 0.6.10
 */
import { Applicative4 } from 'fp-ts/es6/Applicative'
import { Apply4 } from 'fp-ts/es6/Apply'
import { Bifunctor4 } from 'fp-ts/es6/Bifunctor'
import * as E from 'fp-ts/es6/Either'
import { Predicate, Refinement } from 'fp-ts/es6/function'
import { Functor4 } from 'fp-ts/es6/Functor'
import { Monad4 } from 'fp-ts/es6/Monad'
import { MonadIO4 } from 'fp-ts/es6/MonadIO'
import { MonadTask4 } from 'fp-ts/es6/MonadTask'
import { MonadThrow4 } from 'fp-ts/es6/MonadThrow'
